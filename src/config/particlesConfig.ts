...
const particlesConfig: any = {}; // Initialize particlesConfig
...
particlesConfig.particles = {
    ...
    move: {
        ...
        direction: "none", // 'as const' makes TypeScript treat "none" as a literal type rather            random: true, // Movement is random and fluid
...
particlesConfig.retina_detect = true; // Enable retina display support
